...
public class AdminPassword {
		...
		public void storePassword(String username, String passwordIn) throws NoSuchAlgorithmException, NoSuchProviderException
		{
			byte[] salt = getSalt();
	        ...
	        String regeneratedPassowrdToVerify = getSecurePassword(passwordIn, salt);
